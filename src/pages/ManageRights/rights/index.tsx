...
import { Button, Card, Col, Divider, Form, Row, Space, Table, TableColumnsType, Tabs, theme } from 'antd';
...
const Rights: React.FC = () => {
    ...
    const columns: TableColumnsType<DataType> = [
        { title: 'เมนู', dataIndex: 'menu', key: 'menu', align: 'center', render: (record: any) => <p style={{ textAlign: 'left' }}>{record}</p> },
        Table.EXPAND_COLUMN,

        Table.SELECTION_COLUMN,
        { title: 'สิทธิ์การเข้าถึงระบบ', dataIndex: 'permissions', key: 'permissions', align: 'center', },
    ];
